...
kops create cluster --name hari.k8s.local --zones ap-south-1a --control-plane-image ami-0d176f79571d18a8f --control-plane-count=1 --control-plane-size c7i-flex.large --image ami-0f918f7e67a3323f0 --node-count=2 --node-size c7i-flex.large
